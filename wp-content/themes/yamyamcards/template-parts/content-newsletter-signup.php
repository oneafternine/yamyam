                ...
                <div class="o-layout__item  u-1/1  u-3/4@tablet">
                    ...
                    <div class="nesletter__form">
                        ...
                        <div class="mc-field-group">
                            ...
                            <input type="email" value="" name="EMAIL" class="required email form__field" id="mce-EMAIL" placeholder="Email address">
                        </div>
                            ...
                            <input type="submit" value="Tell me about awesome cards!" name="subscribe" id="mc-embedded-subscribe" class="button form__btn">
                            </div>
                        </form>
                        </div>
                        <!--End mc_embed_signup-->
