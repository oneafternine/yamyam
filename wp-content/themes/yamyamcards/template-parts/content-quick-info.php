<?php
/**
 * Template part for the quick info row
 *
    ...
    <div class="o-container o-row">
        <div class="o-layout">
            <div class="c-info-row__item o-layout__item  u-1/1  u-1/3@tablet">
                ...
                <h5 class="c-info_item__title">50p postage &amp; packaging across the UK</h3>
            </div>
            <div class="c-info-row__item o-layout__item  u-1/1  u-1/3@tablet">
                <div class="c-info_item__icon">
                    <img src="<?php echo get_template_directory_uri() ?>/assets/images/head-small--pink.png" width="80" height="80">
                </div>
                <h5 class="c-info_item__title">3 for £6 on all designs</h3>
            </div>
            <div class="c-info-row__item o-layout__item  u-1/1  u-1/3@tablet">
                <div class="c-info_item__icon">
